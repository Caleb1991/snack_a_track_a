...
review_6 = users_snack_6.reviews.create!(description: 'TASTY!', rating: 5.0)
review_7 = users_snack_7.reviews.create!(description: 'My childhood reborn.', rating: 5.0)
review_8 = users_snack_8.reviews.create!(description: 'Best warmed up.', rating: 5.0)
